...
**Clipboard history and screen capture for Windows 11, without the native limits.**
...
- **Screen capture** like Win+Shift+S, plus scrolling capture and a proper editor.
